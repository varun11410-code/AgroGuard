...
export default function SupportedCropsSection() {
  return (
    <section className="relative w-full py-[120px] px-[8%] z-10" id="crops">
      <div className="container mx-auto max-w-[1400px]">
        ...
        <div className="text-center mb-[48px] max-w-3xl mx-auto flex flex-col items-center">
          ...
          <h2 className="text-[clamp(2.2rem,4vw,3.5rem)] font-[800] tracking-tight text-white mb-4 font-['Syne',sans-serif] leading-[1.1]">
        ...
        {/* Crops Grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-[25px] max-w-[800px] mx-auto">
          {supportedCrops.map((crop) => (
            <div
              key={crop.id}
              className="relative bg-[rgba(255,255,255,0.08)] backdrop-blur-[24px] border border-[rgba(255,255,255,0.12)] rounded-[28px] p-[50px_40px] text-center shadow-[0_10px_40px_rgba(0,0,0,0.25)] transition-transform duration-300 hover:-translate-y-[8px] group overflow-hidden cursor-pointer"
            >
              ...
              {/* Crop Icon */}
              <span className="text-[80px] block mb-[20px] drop-shadow-[0_10px_20px_rgba(0,0,0,0.4)] transition-transform duration-300 group-hover:scale-110 group-hover:-translate-y-[6px] leading-none">
                {crop.icon}
              </span>
        ...
        <div className="text-center mt-[28px]">
          <div className="inline-block px-[24px] py-[14px] rounded-full bg-[rgba(245,158,11,0.08)] border border-[rgba(245,158,11,0.2)] text-[#f59e0b]/80 text-[0.82rem] font-['Space_Mono',monospace] tracking-[0.05em]">
